...
//
//	用户通过 opencode 客户端发 `max_tokens:32000`，proxy 在 OpenAIUseCase.forwardChatNative
...
//
// 修复（见 internal/application/llmproxy/usecase/openai.go: forwardChatNative）：删除 silent 改写，改为原样透传。
//
