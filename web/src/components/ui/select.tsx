...
function Select(props: Parameters<typeof SelectPrimitive.Root>[0]) {
...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        "flex h-9 w-full items-center justify-between rounded-lg border border-input bg-transparent px-3 py-2 text-sm ring-offset-background focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/40 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 dark:bg-input/30 dark:data-placeholder:text-muted-foreground moonshot:bg-input/30 moonshot:data-placeholder:text-muted-foreground",
        className
      )}
      {...props}
    >
