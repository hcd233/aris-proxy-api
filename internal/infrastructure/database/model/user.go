...
type User struct {
	...
	Permission   enum.Permission `json:"permission" gorm:"column:permission;not null;default:'reader';uniqueIndex:idx_user_single_demo,where:permission = 'demo' AND deleted_at = 0;comment:权限"`
