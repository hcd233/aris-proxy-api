...
type Blocked struct {
	BaseModel
	DeletedAt int64  `json:"deleted_at" gorm:"column:deleted_at;default:0;comment:删除时间，默认为0;uniqueIndex:idx_blocked_word_deleted,priority:2"`
	Word      string `json:"word" gorm:"column:word;type:varchar(512);not null;uniqueIndex:idx_blocked_word_deleted,priority:1;comment:敏感词"`
