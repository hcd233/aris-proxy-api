...
func initMetricsRouter(metricsGroup huma.API, metricsHandler handler.MetricsHandler, demoAccessor demoport.DemoModuleAccessor, auditSubmitter demoport.DemoSubmitter) {
