...
var (
	...
	TracePayloadFieldOutput              = "output"
	TracePayloadFieldName                = "name"
	TracePayloadFieldMessage             = "message"
	TracePayloadFieldPrompt              = "prompt"
	TracePayloadFieldLastMessage         = "last_assistant_message"
	TracePayloadFieldToolName            = "tool_name"
	...
	TracePayloadFieldBaseInstructions    = "base_instructions"
	TracePayloadFieldDynamicTools        = "dynamic_tools"
	TracePayloadFieldText                = "text"
	TracePayloadFieldDescription         = "description"
	TracePayloadFieldParameters          = "parameters"
	TraceConversationRoleUser            = "user"
	TraceConversationRoleAssistant       = "assistant"
	TraceConversationRoleSystem          = "system"
	TraceConversationKindMessage         = "message"
	TraceConversationKindToolCall        = "tool_call"
	TraceConversationMessageKeySeparator = "\x00"
	TraceConversationEventUserMessage    = "user_message"
	TraceConversationEventAgentMessage   = "agent_message"
	TraceConversationEventFunctionCall   = "function_call"
	TraceConversationEventFunctionOutput = "function_call_output"
	TraceConversationEventUserPrompt     = "UserPromptSubmit"
	TraceConversationEventStop           = "Stop"
	TraceConversationEventPreToolUse     = "PreToolUse"
	TraceConversationEventPostToolUse    = "PostToolUse"
	TraceConversationDefaultTurn         = "session"
	TraceConversationPageSize            = 1000
