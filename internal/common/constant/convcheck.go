...
const (
	...
	ConvCheckMsgLocalConst            = "local const blocks are prohibited in internal/ and cmd/ packages; move to internal/common/constant or internal/enum"
...
const (
	...
	ConvCheckMsgZapLoggerField     = "zap.Logger must not be used as a struct field; get logger from context or logger package inside the method"
