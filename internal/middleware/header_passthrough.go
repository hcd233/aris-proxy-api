...
// passthroughExcludedHeaders 不透传到上游的请求头。
// Fiber 已标准化 header name，使用 HTTPHeader 常量直接匹配。
...
var passthroughExcludedHeaders = map[string]struct{}{
	...
	constant.HTTPHeaderXForwardedFor:      {},
	constant.HTTPHeaderXForwardedProto:    {},
	constant.HTTPHeaderXForwardedPort:     {},
	constant.HTTPHeaderXRealIP:            {},
	constant.HTTPHeaderRemoteHost:         {},
}
