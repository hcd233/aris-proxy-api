...
description: Use when the user asks to deploy, release, publish, ship, or verify aris-proxy-api in production.
---
...
本技能覆盖完整生产发布闭环：本地门禁、提交并推送、等待 CI 构建、服务器部署、镜像确认、线上 E2E 回归。
