...
| [docs/agents/workflow.md](docs/agents/workflow.md) | Skill 路由、开发工作流、任务分类 | 收到新任务时 |
...
| [docs/agents/repo-ci.md](docs/agents/repo-ci.md) | CI workflow、K8s 部署、Git 分支规范 | 涉及 git/CI/部署时 |
